...
const angular={Component:()=>target=>target,Injectable:()=>target=>target,ViewChild:()=>()=>{},Input:()=>()=>{},signal(value){const fn=()=>value;fn.set=v=>value=v;fn.update=f=>value=f(value);return fn}}
